...
if (config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'need ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
...
*/
    MyPnky.addCommand({pattern: 'yts ?(.*)', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
